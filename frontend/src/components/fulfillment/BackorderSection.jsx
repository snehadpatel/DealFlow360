...
export default function BackorderSection({ backorders }) {
  if (!backorders || backorders.length === 0) {
    return (
      <div className="bg-success-50 border border-success-200 rounded-2xl p-6 flex flex-col items-center justify-center text-center">
  ...
  return (
    <div className="bg-white border border-danger-200 rounded-2xl shadow-md overflow-hidden">
              ...
              <tr key={idx} className="hover:bg-danger-50/30 transition-colors">
                ...
                <td className="p-4 whitespace-nowrap">
                  {item.expectedAvailability ? (
                    ...
                    <span className="text-xs text-textSecondary">TBD</span>
                  )}
                </td>
                <td className="p-4 whitespace-nowrap">
